        ...
        for line in book_file:
            ...
            try:
                with open(pathlib.Path(f"../../scripts/{path}"), encoding='utf-8') as text_file:
                    ...
                    book_data[source_bid]['summary'] = chap['summary']
        ...
        for line in text_file:
            ...
            try:
                with open(pathlib.Path(f"../../scripts/{path}"), encoding='utf-8') as chap_file:
                    ...
                    book_data[source_bid]['text'] += chap['summary']
...
def make_json(fixed_file, split):
    """
    Writes each book's summary and text to a JSON file named 'fixed_longt5_data_{split}.json'.
